...
export const getEmailField = (formik) => {
  return fieldGenerator('email', 'What is your email?',
      formik, 12, 'john.doe123@gmail.com');
};

export const getCompanyField = (formik) => {
  return fieldGenerator('company', 'What Company do you work at?',
      formik, 12, 'BuildConnect');
};

export const getReasonToMentorField = (formik) => {
  return fieldGenerator('reasonToMentor',
      'Why are you interested in being a mentor?',
      formik, 12,
      'I would like to help students grow in the software engineering field.',
      'textarea');
};
