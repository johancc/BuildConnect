...
const NavBar = () => {
  ...
  const loginDialog = (
    <div className="Navbar-loginDialog">
      <Dialog
        fullScreen={fullScreen} aria-labelledby="loginDialog"
  ...
  return (
    ...
    <Navbar collapseOnSelect fixed="sticky-top" expand="lg" variant="light">
      ...
      <Navbar.Toggle
        className="NavBar-toggle" aria-controls="responsive-navbar-nav" />
      <Navbar.Collapse
        id="responsive-navbar-nav" className="justify-content-end ">
